...
public interface EventMapper {
    //글쓰기
	@Insert("INSERT INTO event (eve_num,eve_num,eve_title,eve_content,eve_user,eve_start,eve_end,eve_date,eve_status)  VALUES (event_seq.nextval,#{eve_num},#{mem_num},#{eve_title},#{eve_content},#{eve_user},#{eve_start},#{eve_end},#{eve_date},#{eve_status})")
